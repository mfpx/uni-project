...
class MulticastTx:
    """Class for sending network multicast messages"""
    ...
    def create_socket(self) -> Callable:
        """Creates a socket and sets its parameters"""
    ...
    def create_message(self, msgdata: dict, password: str | int) -> bytes:
        """Creates and encodes a message to be sent"""
...
class MulticastRx:
    """Class for receiving/acknowledging multicast messages"""
